...
def get_sales_data():
    """
    get sales figures input from the user. Run a while loop
    to collect a valid string of data from the user via the terminal,
    which must be a string of six numbers seperated by comas.
    The loop will repeatedly request data untill it is valid
    """
    while True:
...
def update_worksheet(data, worksheet):
    ...
    print(f"{worksheet} worksheet updated successfullly.\n")
